                                    ...
                                    <div className="extra-roles">
                                        <div className="extra-role">
                                            ...
                                            <ul className="extra-role-points">
                                                ...
                                                <li>Developed the real-time autonomous traversal system for IRC 2023 using visual arrow detection-based directional pose estimation for precise heading recognition and spatial navigation.</li>
                                            </ul>
                                        </div>
                                        <div className="extra-role">
